...
export async function generateStaticParams(): Promise<{ slug: string }[]> {
  const slugs = await sanityClient.fetch<string[]>(ALL_REGULATION_SLUGS_QUERY);
...
export default async function BlogRegulationPage({ params }: BlogRegulationPageProps) {
  ...
  const posts = await sanityClient.fetch<Post[]>(POSTS_BY_REGULATION_QUERY, { regulationSlug: slug });
